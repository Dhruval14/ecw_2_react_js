...
function App() {
    ...
    const [showProjectPopup, setShowProjectPopup] = useState(false); // Added state for Project Lookup Popup
    // Toggle functions for popups
    const togglePopup = () => setShowPopup(!showPopup);
    const toggleClientPopup = () => setShowClientPopup(!showClientPopup);
    const toggleTaskPopup = () => setShowTaskPopup(!showTaskPopup);
    const toggleProjectPopup = () => setShowProjectPopup(!showProjectPopup); // Added toggle function
    ...
    return (
        <div className="app">
            ...
            {/* Project Lookup Popup */}
            {showProjectPopup && (
                <div className="popup project-lookup">
                    <div className="popup-header">
                    ...
                    <div className="popup-content">
                        <div className="popup-form">
                            ...
                            <input type="text" placeholder="Search by contains" />
                            <label>And:</label>
                            <select>
